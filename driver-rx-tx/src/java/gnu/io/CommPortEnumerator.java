...
//	private final static boolean debug = false;
	static
	{
		RXTXlog.printDebug("CommPortEnumerator:{}");
	}

	CommPortEnumerator()
	{
		RXTXlog.printDebug("CommPortEnumerator() constructor");
	}
/*------------------------------------------------------------------------------
        nextElement()
        accept:
...
------------------------------------------------------------------------------*/
	...
	{
		RXTXlog.printDebug("CommPortEnumerator:nextElement()");
...
------------------------------------------------------------------------------*/
	...
	{
		RXTXlog.printDebug("CommPortEnumerator:hasMoreElements() " + CommPortIdentifier.CommPortIndex == null ? "false" : "true" );
		synchronized (CommPortIdentifier.Sync)
		{
