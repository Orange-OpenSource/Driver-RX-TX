...
#define NO_SUCH_PORT_EXCEPTION "gnu/io/NoSuchPortException"
...
int is_device_locked(JNIEnv *, const char * );
int check_lock_status(JNIEnv *, const char * );
...
void fhs_unlock(JNIEnv *,const char *, int );
int fhs_lock(JNIEnv *, const char *, int);
void uucp_unlock(JNIEnv *, const char *, int );
int uucp_lock(JNIEnv *, const char *, int );
int system_does_not_lock( const char *, int );
void system_does_not_unlock( const char *, int );
int check_group_uucp(JNIEnv *);
int check_lock_pid(JNIEnv *, const char *, int );
